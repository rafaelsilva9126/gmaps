...
@PropertySource(factory = YAMLPropertySourceFactory.class, value="data.yaml")
public class DataProperties implements IProperties  {

	@Override
	public ConfigurableEnvironment loadProperties() {
		AnnotationConfigApplicationContext context = new AnnotationConfigApplicationContext();
		try {
			context.register(DataProperties.class);
			context.refresh();
